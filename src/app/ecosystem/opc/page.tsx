      ...
      <nav className="bg-white border-b border-gray-200">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span className="text-[#00796B] font-semibold">OPC生态</span>
          </nav>
        </div>
      </nav>

      {/* Hero Banner */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#00796B] via-[#009688] to-[#00A896] text-white">
