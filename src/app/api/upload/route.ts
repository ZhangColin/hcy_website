...
// 允许的图片类型目录
const ALLOWED_TYPES_DIRS = ['highlights', 'news', 'news/editor', 'hero', 'partners', 'honors', 'uploads', 'contacts', 'qrcode', 'cases', 'cases/cover', 'cases/logo', 'cases/trophy', 'experts', 'links', 'products'];
