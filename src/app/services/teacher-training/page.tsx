...
const careerPaths = [
  { title: "通识教学", icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
  { title: "专任教学", icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
  { title: "教研管理", icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
  { title: "科创竞赛指导", icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" },
];
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      面对面深度培训，涵盖AI课程教学方法论、平台操作实训、课堂管理技巧等核心模块，由资深专家团队亲自授课。
                    </p>
                  </div>
                  <div className="border-t border-gray-100 pt-6">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      AI数字人7x24小时在线辅导，随时解答教学疑问，提供个性化学习路径推荐与实时教学反馈。
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
              ...
              <div className="p-8">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    { name: "指令工程", desc: "掌握AI对话与提示词技巧" },
                    { name: "视觉设计", desc: "AI辅助教学素材创作" },
                    { name: "多模态视频", desc: "AI视频生成与编辑" },
                    { name: "AI编程", desc: "零基础AI编程入门" },
                    { name: "综合实战", desc: "跨学科AI教学实践" },
                    { name: "更多专题", desc: "持续更新中..." },
                  ].map((topic) => (
